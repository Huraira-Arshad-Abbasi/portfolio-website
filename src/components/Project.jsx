...
const projects = [
  ...
  { id: '04', name: 'Website Clones & UI Practice Projects', technologies: 'HTML, CSS, JavaScript', description: 'Created several frontend clones of websites as part of self-learning and UI development practice. These projects helped strengthen my skills in layout design, responsiveness, and understanding modern web structure. Though not yet uploaded to GitHub, they reflect hands-on experience with real-world UI patterns and component-based design.' }
]
